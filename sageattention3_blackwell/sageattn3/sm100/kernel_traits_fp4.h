...
///////////////////////////////////////////////////////////////////////////////
// SM100 FP4 Block-Scaled Flash Forward Kernel Traits - Tensor Optimized
//
// This version uses the optimized tensor core mainloop with cooperative
// SMEM loading and better memory access patterns.
///////////////////////////////////////////////////////////////////////////////

template <
    int kHeadDim_,    // Head dimension (256 for FP4)
    int kBlockM_,     // Block size for Q rows (128)
    int kBlockN_,     // Block size for K/V sequence (256)
...
struct Flash_fwd_kernel_traits_sm100_fp4_tensor {
    ...
    // For optimized tensor core implementation
    // Use 4 warps (128 threads) for better occupancy and parallelism
    static constexpr int kNWarps = 4;
    static constexpr int kNThreads = kNWarps * 32;  // 128 threads
    ...
    // Number of MMA iterations along K (HeadDim)
