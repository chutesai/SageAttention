...
>
struct SharedStorageQKVOwithSFSm100 : cute::aligned_struct<128, _0>{
...
struct Flash_fwd_kernel_traits_sm100 {
    ...
    using TiledMmaQK = decltype(cute::make_tiled_mma(
        cute::SM100_MMA_MXF4_SS<ElementQMma, ElementKMma, ElementAccum, ElementSF,
                                128, 32, SFVectorSize, UMMA::Major::K, UMMA::Major::K>{},
        AtomLayoutMNK{},
    ...
    using SmemLayoutAtomK = decltype(cutlass::gemm::collective::detail::sm100_smem_selector<UMMA::Major::K, Element,
    ...
    using SmemCopyAtomQ = Copy_Atom<SM100_SU4_DU8x16_x1_LDSM_N, Element>;
    using SmemCopyAtomKV = Copy_Atom<SM100_SU4_DU8x16_x1_LDSM_N, Element>;
